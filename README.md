...
![Intro](docs/images/ms-afcc-qr-reload_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [afcc-qr-reload](#backend_afcc-qr-reload)
        * [Environment variables](#backend_afcc-qr-reload_env_vars)
        * [Event Sourcing](#backend_afcc-qr-reload_eventsourcing)
        * [CronJobs](#backend_afcc-qr-reload_cronjobs)
...
│   ├── afcc-qr-reload                     => Micro-BackEnd responsible for ...
...
Note: You may find the GraphQL schema [here](apigatewayraphql/afcc-qr-reload/schema.gql)
...
### GraphQL Queries
#### getHelloWorldFromafcc-qr-reload
...
#### afcc-qr-reloadHelloWorldSubscription
...
## afcc-qr-reload <a name="backend_afcc-qr-reload"></a>
...


### Environment variables <a name="backend_afcc-qr-reload_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/afcc-qr-reload/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-afcc-qr-reload.yaml)

### Event Sourcing <a name="backend_afcc-qr-reload_eventsourcing"></a>
...
### CronJobs <a name="backend_afcc-qr-reload_cronjobs"></a>
...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-pyxis/ms-afcc-qr-reload.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-pyxis/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-afcc-qr-reload/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-afcc-qr-reload/etc/mfe-setup.json
```

### 6. Compose the API gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-pyxis/gateway --api-id=gateway --output-dir=FULL_PATH_TO_REPO/ms-afcc-qr-reload/playground/gateway  --setup-file=FULL_PATH_TO_REPO/ms-afcc-qr-reload/etc/mapi-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-afcc-qr-reload/backend/afcc-qr-reload/.env   *WORKING_FOLDER*/ms-afcc-qr-reload/playground/gateway/.env  
